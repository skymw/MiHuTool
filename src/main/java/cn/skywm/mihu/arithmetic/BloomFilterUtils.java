package cn.skywm.mihu.arithmetic;
...
//    private BitSet bits = new BitSet(256 << 22);
    ...
    public BloomFilterUtils(int length) {
    ...
    public static void main(String[] args) {
        ...
        BloomFilterUtils bloomFileter = new BloomFilterUtils(1000000000);
